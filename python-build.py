...
class config:
    ...
    def cname_init(self):
        cname = "data-blog.jnapolitano.io"
        return cname
...
class build_pipeline:
    ...
    def make_clean(self):
        ...
        #subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'my_package'])
        result = subprocess.run(['gatsby', 'clean'], capture_output=True, text=True)
        print(result.stdout)
        print(result.stderr)
    ...
    def make_html(self):
        ...
        #subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'my_package'])
        result = subprocess.run(['gatsby', 'build'], capture_output=True, text=True)
        print(result.stdout)
        print(result.stderr)
        ##print("i make it")
